...
- Generally, before developing enhancements to this charm, you should consider [opening an issue](https://github.com/canonical/kafka-connect-k8s-operator/issues) explaining your problem with examples, and your desired use case.
...
git clone https://github.com/canonical/kafka-connect-k8s-operator.git
...
juju deploy kafka-k8s --channel 3/edge --config roles="broker,controller"
